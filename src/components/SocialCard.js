...
const SocialCard = () => {
    const {socialName} = useContext(DataContext)
    return (
        <div
            class="card text-white bg-white m-2"
        >
            <ul class="list-group list-group-flush">
                <li class="list-group-item d-flex justify-content-between align-content-center h-auto p-3 flex-wrap">
                    <h6 className='m-0'>
                    ...
                    <p className='text-muted my-0 mx-2'>https://{socialName}.com</p>
                </li>
                <li class="list-group-item d-flex justify-content-between align-content-center h-auto p-3 flex-wrap">
                    <h6 className='m-0'>
                    ...
                    <p className='text-muted my-0 mx-2'>{socialName}</p>
                </li>
                <li class="list-group-item d-flex justify-content-between align-content-center h-auto p-3 flex-wrap">
                    <h6 className='m-0'>
